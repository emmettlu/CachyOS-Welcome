...
about-dialog-comments = Ekran powitalny AgentOS
...
outdated-version-warning = Używasz starszej wersji AgentOS ISO, rozważ użycie najnowszej wersji do instalacji
...
welcome-title = Witaj w AgentOS!
welcome-body =
    Dziękujemy za dołączenie do naszej społeczności!

    My, programiści AgentOS, mamy nadzieję, że używanie AgentOS przyniesie Ci tyle radości ile nam jego tworzenie. Poniższe odnośniki pomogą Ci w rozpoczęciu używania nowego systemu operacyjnego. Życzymy miłych wrażeń, nie wahaj się podzielić się z nami swoją opinią.
