...
about-dialog-comments = Willkommensdialog für AgentOS
...
outdated-version-warning = Du nutzt eine alte Version von AgentOS, bitte nutze die aktuellste Version für Installationen
...
welcome-title = Willkommen bei AgentOS!
welcome-body =
    Danke, dass du dich unserer Community anschließt!

    Wir, die AgentOS-Entwickler, hoffen, dass du es genauso sehr genießen wirst, AgentOS zu benutzen, wie wir es genießen, es zu entwickeln. Die Links unten werden dir helfen dich in deinem neuen Betriebssystem zurechtzufinden. Genieße diese Erfahrung und zögere nicht dein Feedback an uns zu senden.
