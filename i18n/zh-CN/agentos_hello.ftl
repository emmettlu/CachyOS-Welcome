# About dialog
about-dialog-title = AgentOS 欢迎
about-dialog-comments = AgentOS 的欢迎界面
...
outdated-version-warning = 您正使用 AgentOS 的一个旧版 ISO，请考虑使用最新版来安装
...
welcome-title = 欢迎使用 AgentOS！
welcome-body =
    欢迎您加入我们的社区！

    我们是 AgentOS 的开发者，希望您能像我们开发一样愉快地使用 AgentOS！下方的链接将帮助您开始探索您的新操作系统，请尽管享受您的体验，如果您有任何的反馈或意见，不用犹豫！发送给我们！
