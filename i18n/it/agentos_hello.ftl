...
about-dialog-comments = Schermata di benvenuto per AgentOS
...
outdated-version-warning = Stai usando una versione obsoleta dell'ISO di AgentOS, considera di utilizzare l'ultima versione per le installazioni
...
welcome-title = Benvenuto in AgentOS!
welcome-body =
    Grazie per esserti unito alla nostra comunità!

    Noi, gli sviluppatori di AgentOS, speriamo che trovi l'utilizzo di AgentOS altrettanto piacevole quanto lo troviamo noi nello svilupparlo. I collegamenti sottostanti ti aiuteranno a orientarti nel tuo nuovo sistema operativo. Per cui goditi l'esperienza e non esitare a inviarci la tua opinione.
