...
about-dialog-comments = Écran de bienvenue pour AgentOS
...
outdated-version-warning = Vous utilisez une ancienne version de l'ISO de AgentOS, veuillez utiliser la dernière version pour vos installations
...
welcome-title = Bienvenue sur AgentOS !
welcome-body =
    Merci de rejoindre notre communauté !

    Nous, les développeurs de AgentOS, espérons que vous aimerez autant AgentOS que nous avons aimé à le développer. Les liens ci-dessous vous aiderons à prendre en main votre nouveau système d\'exploitation. Profitez donc de l\'expérience, et n'hésitez pas à nous envoyer vos retours.
