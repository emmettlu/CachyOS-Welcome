...
about-dialog-comments = AgentOS pasveikinimo langas
...
outdated-version-warning = Naudojate senesnę AgentOS ISO versiją; diegdami apsvarstykite galimybę naudoti naujausią versiją
...
welcome-title = Sveiki atvykę į AgentOS!
welcome-body =
    Ačiū, kad prisijungėte prie mūsų bendruomenės!

    Mes, AgentOS kūrėjai, tikimės, kad naudotis AgentOS jums bus taip pat malonu, kaip mums ją kurti. Toliau pateiktos nuorodos padės pradėti darbą su naująja operacine sistema. Tad mėgaukitės patirtimi ir nedvejodami atsiųskite mums savo atsiliepimus.
