...
about-dialog-comments = Приветственный экран AgentOS
...
outdated-version-warning = Вы используете устаревшую версию AgentOS ISO, пожалуйста, рассмотрите возможность использования последней версии для установки
...
welcome-title = Добро пожаловать в AgentOS!
welcome-body =
    Благодарим Вас за то, что Вы присоединились к нашему сообществу!

    Мы, разработчики AgentOS, надеемся, что пользуясь этой системой, Вы будете испытывать такое же удовольствие, какое испытывали мы, создавая ее. Представленные ниже ссылки помогут Вам начать работу. Наслаждайтесь функционалом AgentOS и оставляйте свои отзывы.
