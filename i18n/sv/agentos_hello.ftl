...
about-dialog-comments = Välkomstskärm för AgentOS
...
outdated-version-warning = Du använder en äldre version av AgentOS ISO, överväg att använda den senaste versionen för installationer
...
welcome-title = Välkommen till AgentOS!
welcome-body =
    Tack för att du ansluter dig till vår gemenskap!

    Vi, AgentOS-utvecklarna, hoppas att du kommer att tycka om att använda AgentOS lika mycket som vi tycker om att bygga det. Länkarna nedan hjälper dig att komma igång med ditt nya operativsystem. Så njut av upplevelsen och tveka inte att skicka oss din feedback.