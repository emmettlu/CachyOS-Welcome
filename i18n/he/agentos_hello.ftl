# About dialog
about-dialog-title = תוכנית קבלת הפנים של AgentOS
about-dialog-comments = תוכנית קבלת פנים עבור AgentOS
...
outdated-version-warning = מחשבך מריץ גרסה ישנה של ה־ISO של AgentOS, נא לשקול להשתמש בגרסה העדכנית לצורך התקנת המערכת
...
welcome-title = ברוך בואך אל AgentOS!
welcome-body =
    תודה שהצטרפת לקהילה שלנו!

    אנחנו, מפתחי AgentOS, מקווים שיהיה לך כיף להשתמש ב־AgentOS כמו שאנחנו נהנים מעבודת הפיתוח שלה. הקישורים הבאים יעזרו לך להתחיל להשתמש במערכת ההפעלה החדשה שלך. מקווים שתהיה לך חוויה מהנה, ולא להסס לשלוח לנו משוב.
