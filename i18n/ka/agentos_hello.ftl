...
about-dialog-comments = AgentOS-ის მისალმების ეკრანი
...
outdated-version-warning = თქვენ იყენებთ AgentOS-ის ISO-ის ძველ ვერსიას. სჯობს, ახალი ვერსია გადმოწეროთ
...
welcome-title = კეთილი იყოს თქვენი მობრძანება AgentOS-ში!
welcome-body =
    მადლობა, რომ შემოუერთდით ჩვენს საზოგადოებას!

    ჩვენ, AgentOS-ის დეველოპერები, ვიმედოვნებთ, რომ თქვენ ისე ისიამოვნებთ AgentOS-ით, როგორც ჩვენ მისი აგებისას. ბმულები ქვემოთ დაგეხმარებათ, თქვენს ახალ ოპერაციულ სისტემასთან მუშაობა დაიწყოთ. ასე რომ, ისიამოვნეთ და ნუ შეიკავებთ თავს, თქვენი აზრი გაგვიზიაროთ.