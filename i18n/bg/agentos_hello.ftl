...
about-dialog-comments = Приветствен екран за AgentOS
...
outdated-version-warning = Използвате по-стара версия на AgentOS ISO. Помислете да използвате най-новата версия за инсталации.
...
welcome-title = Добре дошли в AgentOS!
welcome-body =
    Благодарим ви, че се присъединихте към нашата общност!

    Надяваме се, че ще използвате AgentOS с удоволствие – точно толкова, колкото на нас ни доставя удоволствие да я създаваме. Връзките по-долу ще ви помогнат да започнете работа с новата си операционна система. Насладете се на работата с нея и не се колебайте да ни изпратите обратна връзка.
