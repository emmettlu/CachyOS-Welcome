...
about-dialog-comments = Üdvözlőképernyő a AgentOS-hez
...
outdated-version-warning = Egy régebbi AgentOS ISO-t használsz, a telepítéshez érdemesebb a legújabb verziót használnod
...
welcome-title = Üdvözlünk a AgentOS-ben!
welcome-body =
    Köszönjük, hogy csatlakoztál a közösségünkhöz!

    Mi, a AgentOS fejlesztői reméljük, hogy legalább annyira élvezni fogod a AgentOS használatát, mint amennyire mi élveztük a megalkotását. Az alábbi linkek segítenek az elindulásban az új operációs rendszerrel. Jó szórakozást, és ne habozz visszajelzést küldeni nekünk!
