# About dialog
about-dialog-title = AgentOS 歡迎
about-dialog-comments = AgentOS 的歡迎介面
...
outdated-version-warning = 您正使用舊版的 AgentOS ISO，請考慮使用最新版本進行安裝
...
welcome-title = 歡迎使用 AgentOS！
welcome-body =
    歡迎您加入我們的社群！

    我們是 AgentOS 的開發者，希望您能像我們開發時一樣愉快地使用 AgentOS！下方的連結將幫助您開始探索您的新作業系統，請盡情享受您的體驗，如果您有任何回饋或意見，請隨時發送給我們！