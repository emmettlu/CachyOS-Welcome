...
about-dialog-comments = AgentOS Hoş Geldin Ekranı
...
# Tweaks page — quick launch (AgentOS apps)
app-cachyos-pi-label = AgentOS Paket Kurucu
app-cachyos-kernel-manager-label = AgentOS Çekirdek Yöneticisi
...
outdated-version-warning = Daha eski bir AgentOS ISO sürümü kullanıyorsunuz, lütfen kurulumlar için en son sürümü kullanmayı düşünün
...
welcome-title = AgentOS'e Hoş Geldiniz!
welcome-body =
    Aramıza katıldığınız için size çok teşekkür ederiz!

    AgentOS Geliştirici Ekibi olarak, bizler yapımında ne kadar zevk aldıysak, sizlerin de AgentOS'i kullanırken o kadar memnun kalacağınızı umut ediyoruz. Aşağıdaki bağlantılar, yeni işletim sisteminizi kullanma konusunda sizlere yardımcı olacaktır. Bu vesileyle tecrübenizin tadını çıkarın, fikir ve düşüncelerinizi bizlerle paylaşmaktan çekinmeyin.
