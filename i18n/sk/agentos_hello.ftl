# O dialógu
about-dialog-title = AgentOS Vitajte
about-dialog-comments = Úvodná obrazovka pre AgentOS
...
outdated-version-warning = Používate staršiu verziu AgentOS ISO, zvážte použitie najnovšej verzie pre inštalácie
...
welcome-title = Vitajte v AgentOS!
welcome-body =
    Ďakujeme, že ste sa pridali k našej komunite!

    My, vývojári AgentOS, dúfame, že budete používať AgentOS s rovnakým nadšením, s akým ho my vytvárame. Odkazy nižšie vám pomôžu začať s vaším novým operačným systémom. Užite si zážitok a neváhajte nám poslať vašu spätnú väzbu.
