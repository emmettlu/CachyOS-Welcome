...
about-dialog-comments = AgentOS のようこそ画面
...
outdated-version-warning = 現在古いバージョンの AgentOS ISO を利用しています。インストールには最新バージョンを利用することをおすすめします
...
welcome-title = AgentOS へようこそ！
welcome-body =
    コミュニティに参加いただきありがとうございます！

    AgentOS 開発チーム一同、情熱を持って開発した AgentOS を皆さまに楽しんでいただけることを願っています。下のリンクは、はじめてこの OS を利用する場合に役立ちます。AgentOS をぜひご活用ください。フィードバックもお待ちしております。
