...
about-dialog-comments = Pantalla de bienvenida de AgentOS
...
outdated-version-warning = Se está utilizando una versión antigua de la ISO de AgentOS; por favor, considere usar la última versión para realizar la instalación.
...
welcome-title = ¡Bienvenido a AgentOS!
welcome-body =
    ¡Gracias por unirse a nuestra comunidad!

    Quienes desarrollamos AgentOS deseamos que disfrute este sistema operativo tanto como nosotros disfrutamos creándolo. Los enlaces a continuación le ayudarán a dar sus primeros pasos. Disfrute la experiencia y no dude en enviarnos sus comentarios.
