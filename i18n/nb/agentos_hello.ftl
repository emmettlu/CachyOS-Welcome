...
about-dialog-comments = Velkomstskjermen til AgentOS
...
outdated-version-warning = Du bruker en eldre versjon av AgentOS ISO. Vurder å bruke den nyeste versjonen for installasjoner.
...
welcome-title = Velkommen til AgentOS!
welcome-body =
   Takk for at du blir med i fellesskapet vårt!

    Vi, AgentOS-utviklerne, håper at du vil like å bruke AgentOS like mye som vi liker å bygge det. Lenkene nedenfor vil hjelpe deg med å komme i gang med ditt nye operativsystem. Så nyt opplevelsen, og ikke nøl med å sende oss tilbakemeldingen din.
