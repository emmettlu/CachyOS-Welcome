...
about-dialog-comments = Οθόνη καλωσορίσματος για το AgentOS
...
outdated-version-warning = Χρησιμοποιείτε μια παλαιότερη έκδοση του ISO του AgentOS· καλό θα ήταν να χρησιμοποιείτε την τελευταία έκδοση για τις εγκαταστάσεις
...
welcome-title = Καλώς ορίσατε στο AgentOS!
welcome-body =
    Σας ευχαριστούμε που γίνατε μέλος της κοινότητάς μας!

    Εμείς, οι προγραμματιστές του AgentOS, ελπίζουμε να ευχαριστηθείτε τη χρήση του AgentOS όσο ευχαριστιόμαστε κι εμείς την ανάπτυξή του. Οι παρακάτω σύνδεσμοι θα σας βοηθήσουν να ξεκινήσετε με το νέο σας λειτουργικό σύστημα. Απολαύστε λοιπόν την εμπειρία και μην διστάσετε να μας στείλετε τα σχόλιά σας.
