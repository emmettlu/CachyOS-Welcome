...
about-dialog-comments = Вітальний екран AgentOS
...
outdated-version-warning = Ви використовуєте застарілу версію ISO AgentOS. Рекомендуємо скористатися найновішою
...
welcome-title = Ласкаво просимо до AgentOS!
welcome-body =
    Дякуємо, що приєдналися до нашої спільноти!

    Ми, команда розробників AgentOS, сподіваємося, що вам буде так само приємно користуватися цією системою, як нам — створювати її. Посилання нижче допоможуть швидко розпочати роботу. Насолоджуйтесь і не соромтеся ділитися своїми відгуками.
