...
about-dialog-comments = Welcome screen for AgentOS
...
outdated-version-warning = You are using an older version of AgentOS ISO, please consider using latest version for installations
...
welcome-title = Welcome to AgentOS!
welcome-body =
    Thank you for joining our community!

    We, the AgentOS Developers, hope that you will enjoy using AgentOS as much as we enjoy building it. The links below will help you get started with your new operating system. So enjoy the experience, and don't hesitate to send us your feedback.
