# About dialog
about-dialog-title = Benvinguda del AgentOS
about-dialog-comments = Pantalla de benvinguda per al AgentOS
...
outdated-version-warning = Useu una imatge més antiga del AgentOS. Si us plau, considereu usar-ne la versió més recent per a les instal·lacions.
...
welcome-title = Us donem la benvinguda al AgentOS!
welcome-body =
    Moltes mercès per unir-vos a la nostra comunitat!

    Nosaltres, els desenvolupadors del AgentOS, esperem que gaudiu d'usar el AgentOS tant com a nosaltres ens agrada fer-lo. Els enllaços següents us ajudaran a començar. Gaudiu de l'experiència i no dubteu a enviar-nos-en comentaris.
