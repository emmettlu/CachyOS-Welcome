# O dialogu
about-dialog-title = AgentOS Vítejte
about-dialog-comments = Úvodní obrazovka pro AgentOS
...
outdated-version-warning = Používáte starší verzi AgentOS ISO, zvažte prosím použití nejnovější verze pro instalace
...
welcome-title = Vitejte v AgentOS!
welcome-body =
    Děkujeme, že jste se přidali k naší komunitě!

    My, vývojáři AgentOS, doufáme, že budete používat AgentOS se stejným nadšením, s jakým ho my vytváříme. Odkazy níže vám pomůžou začíť s vaším novým operačním systémem. Užijte si zážitek a neváhajte nám poslat vaší zpětnou vazbu.
