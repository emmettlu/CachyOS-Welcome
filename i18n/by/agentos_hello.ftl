...
about-dialog-comments = Экран прывітання для AgentOS
...
outdated-version-warning = Вы выкарыстоўваеце старую версію AgentOS ISO, калі ласка, разгледзьце магчымасць выкарыстання апошняй версіі для ўстаноўкі
...
welcome-title = Сардэчна запрашаем у AgentOS!
welcome-body =
    Дзякуем за тое, што Вы далучыліся да нашай супольнасці!

    Мы, распрацоўшчыкі AgentOS, спадзяемся, што карыстаючыся гэтай сістэмай, Вы будзеце адчуваць такое ж задавальненне, якое мы адчувалі, ствараючы яе. Прадстаўленыя ніжэй спасылкі дапамогуць Вам пачаць працу. Атрымлівайце асалоду ад функцыяналам AgentOS і пакідайце свае водгукі.
